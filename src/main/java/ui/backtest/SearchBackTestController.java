...
/**
 * Created by island on 2017/3/24.
 */
public class SearchBackTestController implements ControlledStage {
    ...
    public  void backFromStockSelect(Date sDate, Date eDate, String type) {
        initial();
    ...
    private void confirm(){
        ...
        if (meanIsSelected == false && momentumIsSelected == false) {
            ...
            mainViewController.setBackTestStockSelectPane(sDate, eDate, "均值回归", "");
        } else if (meanIsSelected == false && momentumIsSelected == true) {
            mainViewController.setBackTestStockSelectPane(sDate, eDate, "动量策略", "");
        }
    }
